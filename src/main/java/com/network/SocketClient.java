...
public class SocketClient {
	...
	public void socketSend(RasPiDetails rasPiDetails) throws UnknownHostException, IOException{
		...
		logger.info(socketServerIp+":"+socketServerPort+"###"+socketServerTimeout);
		...
		logger.info(+rasPiDetails.getComData()[0].getDate()+"|"+rasPiDetails.getComData()[0].getText());
